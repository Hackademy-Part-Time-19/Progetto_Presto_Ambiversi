                    ...
                    <div class="row">
                        ...
                        <div  class="col-6 col-ml-6 col-sm-4 p-1">
                           ...
                           <a style="text-decoration: none" href="  {{route('announcements.show', compact('announcement'))}}  ">
                                ...
                                <button><a href="{{route('categoryShow',['category'=>$announcement->category->id])}}" class="my-2 border-top pt-2 border-dark card-link shadow btn btn-success">Categoria: {{$announcement->category->name}}</a></button>
                                </div>
                           </a>
                        </div>
