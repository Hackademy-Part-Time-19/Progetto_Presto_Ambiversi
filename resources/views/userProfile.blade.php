 ...
 @endforeach
                    ...
                    <div class="boxContent boxSetInfoPers">
                        ...
                        <div class="mb-3">
                            ...
                            <form style="display:flex; justify-content:space-between" id="form1" method="POST"
                                ...
                                <div style="width: 39%">
                                    ...
                                    <input id="name" name="name" style="height: 40px"
                                ...
                                <div style="width: 59%">
                                    <label style="text-align: start; width: 100%; margin-top: 20px" for="email"
                                        class="block text-sm font-medium text-gray-700">Email</label>
                                    <input id="email" name="email" style="height: 40px"
...
<div style="display: flex;  align-items: end;">
                                ...
                                <form  style="width: 100%" id="form2" action="{{ route('number-upload') }}"
                                    method="POST">
                                    @csrf
                                    <label style="text-align: start; width: 100%; margin-top: 10px" for="telephone_number"
                                        class="block text-sm font-medium text-gray-700">Telefono</label>
                                    <input id="telephone_number" style="height: 40px"
                                        placeholder="{{ Auth::user()->telephone_number ?? 'Inserisci il tuo numero' }}" type="text"
                                        name="telephone_number" class="form-control">
                                        
                                </form>
    
                             <button  style="padding: 5px 20px;height:auto" id="submitForms" class="bottoneMostaPasSave"><a style="; height:auto; text-decoration:none" href="{{ route('userProfile') }}">Salva</a></button></div>
